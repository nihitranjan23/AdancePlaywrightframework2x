...
<body>
    ...
    private generateTestDetailPanel(test: TestData): string {
        ...
        <div class="detail-section screenshots-section">
            ...
            <div class="section-content">
                ${test.screenshots.length > 0 ? `<div class="screenshots-grid">` : `<div class="ai-empty">📷 No screenshots captured. Screenshots are captured only on test failure.</div>`}
    ...
    private getStyles(): string {
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Column widths */
        .col-sno { width: 45px; text-align: center; font-weight: 600; color: var(--gray-400); }
        .col-suite { min-width: 100px; }
        .col-testname { min-width: 240px; }
        ...
        .col-starttime, .col-endtime { width: 140px; font-size: 12px; color: var(--gray-500); }
    ...
    private getScripts(): string {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Auto-expand all tests so video/screenshot/trace sections are visible
            document.querySelectorAll('.test-row').forEach(row => {
                const testId = row.getAttribute('data-test-id');
                if (testId) {
